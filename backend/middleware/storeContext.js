 ...
 *   req.isOwner  — true nếu role là "owner" (xem được mọi store)
 *   req.storeId  — Int | null
 *     · owner không truyền ?store_id → null (không lọc)
 *     · owner truyền ?store_id=X    → X   (lọc 1 store cụ thể)
 *     · admin/manager/employee      → store_id từ JWT
 */
