/**
 * AdminSessionModal — Hiện khi JWT admin hết hạn (401)
 * Cho phép admin/manager đăng nhập lại ngay tại chỗ mà không mất trạng thái trang.
 */
...
export default function AdminSessionModal({ onSuccess }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding:"36px 32px", width:380, boxShadow:"0 24px 80px rgba(0,0,0,0.6)",
      }}>
        {/* Header */}
        <div style={{ textAlign:"center", marginBottom:24 }}>
          ...
          <p style={{ color:"#8b90a7", fontSize:13, margin:"8px 0 0" }}>
            Đăng nhập lại để tiếp tục — dữ liệu trang không bị mất
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom:14 }}>
            <label style={{ color:"#8b90a7", fontSize:12, display:"block", marginBottom:6, fontWeight:600, letterSpacing:.5 }}>
              TÊN ĐĂNG NHẬP
            </label>
            <input
              className="adm-input"
          ...
          >
            {loading
              ? <span style={{ display:"inline-flex", alignItems:"center", gap:8 }}><span className="adm-spinner" /> Đang đăng nhập...</span>
              : "Đăng nhập lại"}
          </button>
        </form>
